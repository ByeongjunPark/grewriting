...
export default function StepByStepTraining() {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-50 text-slate-800">
          ...
          <div className="flex items-center space-x-4 animate-fade-in">
            ...
            {timerRunning ? (
              <button 
                ...
                className="text-xs font-bold px-3 py-1.5 border border-slate-350 rounded-lg hover:bg-slate-50 transition cursor-pointer"
              >
                일시정지
              </button>
            ) : (
              <button 
                ...
                className="text-xs font-bold px-3 py-1.5 bg-indigo-600 text-white rounded-lg hover:bg-indigo-750 transition cursor-pointer"
              >
                재개
              </button>
            )}
      ...
      {/* Stepper Indicators */}
      <div className="bg-white border-b border-slate-200 py-3.5 shadow-sm select-none">
        <div className="max-w-5xl mx-auto px-6 flex justify-between items-center text-xs font-bold text-slate-400">
          <button 
            onClick={() => goToStep(1)}
            className={`flex items-center space-x-1.5 pb-1 border-b-2 transition cursor-pointer ${
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-6 py-8 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch flex-1">
            ...
            <div className="lg:col-span-2 space-y-6 flex flex-col justify-between">
              ...
              <div className="pt-6 border-t border-slate-100 flex justify-end">
                <button 
                  onClick={() => goToStep(2)}
                  className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-md hover:shadow-lg flex items-center space-x-2 transition cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch flex-1">
            ...
            <div className="lg:col-span-2 space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {["agree", "disagree", "balanced"].map((s) => (
                      <button 
                        ...
                        className={`py-3 px-4 rounded-xl font-bold text-sm border transition text-center cursor-pointer ${
                          stance === s 
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      placeholder="예: 자유로운 과학 연구가 인류 혁신을 이끎 (예시: 플레밍의 페니실린 발견)"
                      rows={3}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      placeholder="예: (양보) 생명윤리적 위협은 국가 규제가 필요하다. (반박) 하지만 학술적 중립 위원회에 의한 윤리 심의가 안전장치로서 더 작동한다."
                      rows={3}
                      className="w-full border border-slate-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white font-medium"
                      value={rebuttal}
              ...
              <div className="pt-6 border-t border-slate-100 flex justify-between">
                <button 
                  onClick={() => goToStep(1)}
                  className="border border-slate-300 hover:bg-slate-100 text-slate-700 font-bold py-2.5 px-6 rounded-xl transition cursor-pointer"
                >
                  <span>이전 단계</span>
                </button>
                <button 
        ...
        {/* Step 3: Split-Screen Drafting (Fixed height) */}
        {step === 3 && (
            ...
            <div className="lg:col-span-2 space-y-6 flex flex-col justify-between">
              ...
              <div className="pt-6 border-t border-slate-100 flex justify-between space-x-3">
                <button 
                  ...
                  className="border border-slate-350 hover:bg-slate-100 text-slate-700 font-bold py-2.5 px-6 rounded-xl text-sm transition cursor-pointer"
                >
                  에세이 수정하러 돌아가기
                </button>
